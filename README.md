...
The study combines the latest official releases available when the analysis was refreshed on **September 3, 2026**:
...
The original reproducible computation in this repository is the category-level **CE–CPI crosswalk for 2023–2024**. It compares spending and prices over the same two calendar years. The broader article uses the newer releases above to describe current conditions and the age and limits of each source.

## What this repository reproduces

- a 12-row crosswalk between CE spending categories and CPI-U series;
...
![CE spending change versus CPI price change, 2023–2024](charts/ces-cpi-spending-vs-prices-2023-2024.png)
...
![Age of the newest data in four official sources on September 3, 2026](charts/four-official-sources-four-clocks.png)

Every chart is provided in 16:9, 4:3, and 1:1. All nine layouts are available as both SVG and PNG in [`charts/`](charts/).
...
| [`charts/`](charts/) | Nine chart layouts in SVG and PNG |
...
One row—CE **Housing** against CPI **Shelter**—is retained but marked `NOT COMPARABLE` and excluded from conclusions.
